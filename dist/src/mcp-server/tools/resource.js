...
const createResourceTool = {
    ...
    handler: async (args, context) => {
        ...
        const hasAccess = await (0, auth_js_1.validateOrganizationAccess)(context.userId, projectResult.value.organizationId, context);
        if (!hasAccess) {
            return {
...
// Register tools
(0, index_js_1.registerTool)(createResourceTool);
(0, index_js_1.registerTool)(getResourceTool);
(0, index_js_1.registerTool)(listResourcesTool);
(0, index_js_1.registerTool)(deleteResourceTool);
