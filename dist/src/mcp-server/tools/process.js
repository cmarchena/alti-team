...
const getProcessTool = {
    ...
    handler: async (args, context) => {
        ...
        // Check if user has access to the organization
        const hasAccess = await (0, auth_js_1.validateOrganizationAccess)(context.userId, process.organizationId, context);
        if (!hasAccess) {
            return {
                content: [{ type: 'text', text: 'Access denied. You are not a member of this organization.' }],
                isError: true,
...
// Register tools
(0, index_js_1.registerTool)(createProcessTool);
(0, index_js_1.registerTool)(getProcessTool);
(0, index_js_1.registerTool)(listProcessesTool);
(0, index_js_1.registerTool)(startProcessExecutionTool);
(0, index_js_1.registerTool)(getProcessExecutionTool);
(0, index_js_1.registerTool)(completeProcessStepTool);
(0, index_js_1.registerTool)(getProcessAnalyticsTool);
