      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <link_1.default href="/projects" className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
              Back to Projects
            </link_1.default>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        {organizations.length === 0 ? (<div className="text-center py-12">
            ...
            <div className="bg-white rounded-lg shadow border-2 border-dashed border-gray-300 hover:border-gray-400 transition-colors">
              <link_1.default href="/projects" className="block p-6 h-full">
            ...
            <form onSubmit={handleCreateProject}>
              <div className="px-6 py-4 space-y-4">
                ...
                <div>
                  ...
                  <select id="organization" required className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value={formData.organizationId} onChange={(e) => setFormData({ ...formData, organizationId: e.target.value })}>
