  ...
  return {
    users: {
      ...
      update: async (id: string, data: { name?: string; bio?: string }) => {
        ...
        const updated: MockUser = { ...user, ...data, updatedAt: now }
    ...
    organizations: {
      ...
      update: async (
        ...
        const updated: Organization = { ...org, ...data, updatedAt: now }
    ...
    projects: {
      ...
      update: async (id, data) => {
        ...
        const updated: Project = { ...project, ...data, updatedAt: now }
    ...
    processes: {
      ...
      update: async (id, data) => {
        ...
        const updated: Process = { ...process, ...data, updatedAt: now }
    ...
    comments: {
      ...
      update: async (id, data) => {
        ...
        const updated: Comment = { ...comment, ...data, updatedAt: now }
    ...
    teams: {
      ...
      update: async (id, data) => {
        ...
        const updated: Team = { ...team, ...data, updatedAt: now }
